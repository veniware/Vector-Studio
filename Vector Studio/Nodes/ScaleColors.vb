Public Class ScaleColors
    ...
    Private Sub ScaleColors_MouseWheel(sender As Object, e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseWheel
    ...
    Public Overrides Function apply(b As Image) As Image
        Return Filters.ScaleColors(b, value)
    End Function
